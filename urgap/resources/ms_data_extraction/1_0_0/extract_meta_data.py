...
def main(
    input_file: str,
    run_output_file: str | None,
    spec_output_file: str | None,
    noise_output_file: str | None,
    unit_output_file: str | None,
    time_format: str,
    object_name: str,
    lineage_root: str,
) -> None:
    ...
    Args:
        ...
        unit_output_file (str/NoneType): path to instrument units output_file
